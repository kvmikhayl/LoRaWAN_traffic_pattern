...
conf_iter_filename_beginning = 'LoRaWAN_OTAA_rand_x1_3ch';
...
%Data start
conf_iter_Data_start_window_const_s=conf_iter_timeperiod_values/2;
conf_iter_Data_start_window_rand_s=conf_iter_timeperiod_values;

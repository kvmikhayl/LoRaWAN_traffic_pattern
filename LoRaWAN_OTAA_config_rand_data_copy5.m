...
conf_iter_timeperiod_values = [200 240];
%conf_iter_timeperiod_values = [164];
%conf_iter_timeperiod_values = [180 184 188];
conf_iter_filename_beginning = 'LoRaWAN_OTAA_rand_data_3ch';
...
%Join repeat
conf_iter_Join_repeat_window_const_s=conf_iter_timeperiod_values;
conf_iter_Join_repeat_window_rand_s=ones(1,size(conf_iter_timeperiod_values,2))*0;
...
%Data repeat
conf_iter_Data_repeat_window_const_s=conf_iter_timeperiod_values/2;
conf_iter_Data_repeat_window_rand_s=conf_iter_timeperiod_values;
